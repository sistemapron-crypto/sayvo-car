      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex items-center gap-3">
            {/* Right Area: Menu desktop */}
            <div className="flex items-center">
              <button
                type="button"
                onClick={() => setMenuAberto(!menuAberto)}
                className="flex items-center justify-center w-10 h-10 rounded-lg bg-white/10 border border-white/20 text-white transition-colors"
              ...
              {/* Contact Menu */}
              {menuAberto && (
                <div className="absolute top-full right-4 mt-2 w-44 rounded-xl bg-black border border-white/10 shadow-lg overflow-hidden">
                  <a
